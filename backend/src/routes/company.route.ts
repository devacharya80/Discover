...
import { createJobController,getAllCompanyJobsController,getCompanyJobController } from "../controller/job.controller.js";
...
companyRouter.get("/:companyId/jobs",authenticate,getAllCompanyJobsController)
